...
En la clase `Menu`, hemos realizado varios cambios para embellecer el menú. Se cargan y escalan las imágenes de los botones y de Franklin, además de cargar la música de fondo. En el método `draw`, se dibujan las imágenes y se escribe el texto en la pantalla. En el método `update`, se actualiza la imagen que se muestra cada 60 frames. Finalmente, en el método `handle_event`, se manejan los eventos de pulsar el botón de jugar y de salida, deteniendo la música cuando se inicia el juego.

Además agregamos esta línea en el método main para que se puedan reproducir la música:

```python
def main():
    pygame.init()			
		pygame.mixer.init() # inicializamos el módulo mixer
		# Resto del codigo
```
...
![Untitled](Finals%20Frenzy%20Christmas%20Edition%20ddb529c67b5c46d0b6630f1bf225600e/Untitled%2010.png)
...
![Untitled](Finals%20Frenzy%20Christmas%20Edition%20ddb529c67b5c46d0b6630f1bf225600e/Untitled%2011.png)

![Untitled](Finals%20Frenzy%20Christmas%20Edition%20ddb529c67b5c46d0b6630f1bf225600e/Untitled%2012.png)